...
<div class="row">
    <div class="col-10 mx-auto">
        <div class="card">
            {{ html()->modelForm($alternatecontact, 'PUT', route('alternatecontacts.update', $alternatecontact))->open() }}
                {{ html()->hidden('id') }}
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-3">
                            <a class="btn btn-primary float-left" href="{{ route('newapplication.alternate', $alternatecontact->newapplication) }}" onclick="return(confirm('Changes on this page will be lost if return to the previous page. Do you want to proceed?'));">Previous</a>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-3">
