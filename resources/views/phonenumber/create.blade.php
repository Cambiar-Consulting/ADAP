...
<div class="row">
    <div class="col-10 mx-auto">
        <div class="card">
            {{ html()->modelForm($newApplication, 'POST', route('newapplication.phonenumbers.store', $newApplication))->open() }}
                {{ html()->hidden('id') }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        {{ html()->text('number')->class('form-control')->data('inputmask', "'mask': '(999) 999-9999'") }}
                    </div>
                    <div class="form-group">
                        Phone Type:
                        @foreach($phoneNumberTypes as $type)
                            <div class="form-check">
                                {{ html()->radio('phone_number_type_id')->class('form-check-input')->id('phone_number_type_id_' . $type->id)->value($type->id)->checked(old('phone_number_type_id') == $type->id) }}
