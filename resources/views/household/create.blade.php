...
<div class="row">
    <div class="col-10 mx-auto">
        <div class="card">
            {{ html()->form('POST', route('newapplication.households.store', $newApplication))->open() }}
                    ...
                    <div class="form-group">
                        ...
                        @foreach($payment_frequencies as $frequency)
                            <div class="form-check">
                                {{ html()->radio('payment_frequency_id')->class('form-check-input')->id('payment_frequency_id_' . $frequency->id)->value($frequency->id)->checked(old('payment_frequency_id') == $frequency->id || $newApplication->payment_frequency_id === $frequency->id) }}
